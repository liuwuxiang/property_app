...
import com.springmvc.utils.wxpay.sdk.WXPayConstants.SignType;
...
//        }
     ...
     * @throws Exception
     */
    public Map<String, String> withdrawToBankCard(Map<String, String> reqData) throws Exception {
        return this.withdrawToBankCardOrder(reqData, config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    }
     ...
     * @throws Exception
     */
    public Map<String, String> withdrawToBankCardOrder(Map<String, String> reqData,  int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url = WXPayConstants.WITHDRAW_FK;;
