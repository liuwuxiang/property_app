...
public class HttpClientCustomSSL {
	...
	public static String httpClientResult(TreeMap<String, String> parms) throws Exception{
        ...
        StringEntity myEntity = new StringEntity(requestXML, WeChatConfig.CHARSET);
	...
	public static String httpsUrlRequest(String requestUrl, String outputStr) {
		try {
	        ...
	        FileInputStream instream = new FileInputStream(new File("/usr/local/property_system/apiclient_cert.pem"));
//			FileInputStream instream = new FileInputStream(new File("/Users/zhangfan/Downloads/cert/apiclient_cert.pem"));
	        try {
