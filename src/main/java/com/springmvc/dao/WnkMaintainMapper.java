 ...
 * 功能描述: 系统维护员管理数据持久层
 * @Author: 刘武祥
 * @Date: 2019/2/21 0021 15:34
 */
public interface WnkMaintainMapper {
     ...
     */
    WnkMaintain selectMaintainInfoByBusinessTypeId(@Param("business_type_id") Integer business_type_id);
     ...
     * @date 2018/11/14 14:15
     */
    Map<String,Object> selectMaintainInfoById(@Param("maintain_id") String maintain_id);
     ...
     * @date 2018/11/14 14:15
     */
    WnkMaintain selectMaintainInfoByBusinessTypeIdAll(@Param("business_type_id") Integer business_type_id);
