...
/**
 * @author: zhangfan
 * @Date: 2018/12/8 16:05
 * @Description:2.0版本商品订单记录Mapper
 */
public interface WnkOrdersTwoMapper {
    /**
     *
     * 功能描述: 插入新订单
     *
    ...
    /**
     *
     * 功能描述: 查询某个商家的订单通过商家id以及状态
     *
     * @param:
     * @return:
     * @author: zhangfan
     * @date: 2018/12/9 8:04 PM
     */
    List<Map<Object,Object>> selectOrderByBusinessIdAndState(Integer business_id,Integer state);

    /**
     *
     * 功能描述: 按用户查询消费用户数量(查询消费用户总数列表)
     *
     * @param:
     * @return:
     * @author: zhangfan
     * @date: 2018/12/9 8:01 PM
     */
     ...
     * @date 11:44 2019/1/7
     */
    Map<String,Object> selectUserToDaysBusinessOrderNumber(@Param("user_id") Integer user_id, @Param("business_id") Integer business_id);
