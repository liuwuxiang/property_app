...
/**
 *
 * 功能描述: 商家会员卡开卡协议业务层 - 抽象层
 * @Author: 刘武祥
 * @Date: 2019/2/20 0020 10:22
 */
public interface IWnkBusinessOpenCardProtocolService {
     ...
     * @date    14:45 2019/1/2
     */
    Map<String,Object> selectBusinessOpenCardProtocolById(Integer protocol_id);
     ...
     * @date    14:45 2019/1/2
     */
    Map<String,Object> selectBusinessOpenCardProtocolByBusinessId(Integer business_id);
