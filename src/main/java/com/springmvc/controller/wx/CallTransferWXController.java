...
public class CallTransferWXController {
    @Resource
    private LoginSessionIdsService sessionIdsService;

    //进入授权管理主页
    @RequestMapping(value = "/joinCallTransfer")
    @ResponseBody
    public ModelAndView joinCallTransfer(HttpServletRequest request){
        ...
        if (isLogin == false){
            ...
            modelAndView = new ModelAndView("wx/property_center/call_transfer");
        }
        return modelAndView;
