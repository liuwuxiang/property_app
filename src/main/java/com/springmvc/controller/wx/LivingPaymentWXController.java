...
public class LivingPaymentWXController {
    @Resource
    private LoginSessionIdsService sessionIdsService;

    //进入生活缴费主页
    @RequestMapping(value = "/joinLivingPayment")
    @ResponseBody
    public ModelAndView joinLivingPayment(HttpServletRequest request){
        ...
        if (isLogin == false){
            ...
            modelAndView = new ModelAndView("wx/property_center/living_payment");
        }
        return modelAndView;
