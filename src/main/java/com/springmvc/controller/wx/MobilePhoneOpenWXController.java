...
public class MobilePhoneOpenWXController {
    @Resource
    private LoginSessionIdsService sessionIdsService;

    //进入手机开门主页
    @RequestMapping(value = "/joinMobilePhoneOpen")
    @ResponseBody
    public ModelAndView joinMobilePhoneOpen(HttpServletRequest request){
        ...
        if (isLogin == false){
            ...
            modelAndView = new ModelAndView("wx/property_center/mobile_phone_open");
        }
        return modelAndView;
