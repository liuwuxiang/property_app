...
public class RepairSubmitWXController {
    @Resource
    private LoginSessionIdsService sessionIdsService;

    //进入物业联系主页
    @RequestMapping(value = "/joinContactProperty")
    @ResponseBody
    public ModelAndView joinContactProperty(HttpServletRequest request){
        ...
        if (isLogin == false){
            ...
            modelAndView = new ModelAndView("wx/property_center/contact_property");
        }
        return modelAndView;
