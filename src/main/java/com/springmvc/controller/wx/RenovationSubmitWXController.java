...
public class RenovationSubmitWXController {
    @Resource
    private LoginSessionIdsService sessionIdsService;

    //进入装修申请主页
    @RequestMapping(value = "/joinRenovationSubmit")
    @ResponseBody
    public ModelAndView joinRenovationSubmit(HttpServletRequest request){
        ...
        if (isLogin == false){
            ...
            modelAndView = new ModelAndView("wx/property_center/renovation_submit");
        }
        return modelAndView;
