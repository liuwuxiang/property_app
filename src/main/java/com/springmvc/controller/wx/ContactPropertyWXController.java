...
public class ContactPropertyWXController {
    @Resource
    private LoginSessionIdsService sessionIdsService;

    //进入维修申请主页
    @RequestMapping(value = "/joinPropertyComplaint")
    @ResponseBody
    public ModelAndView joinPropertyComplaint(HttpServletRequest request){
        ...
        if (isLogin == false){
            ...
            modelAndView = new ModelAndView("wx/property_center/property_complaint");
        }
        return modelAndView;
