...
public class SuggestionFeedbackWnkBusinessWXController {
    @Resource
    private LoginSessionIdsService sessionIdsService;

    //进入建议反馈页面
    @RequestMapping(value = "/joinSuggestionFeedback")
    @ResponseBody
    public ModelAndView joinSuggestionFeedback(HttpServletRequest request){
        ...
        if (isLogin == false){
            ...
            modelAndView = new ModelAndView("wnk_business/suggestion_feedback");
        }
        return modelAndView;
    }
}
