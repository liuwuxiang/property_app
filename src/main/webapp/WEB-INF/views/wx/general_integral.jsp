...
<head>
  ...
  <script src="/property_system/js/wx/general_integral.js"></script>
...
<body class="bgw" onload="listOptionInit(0)">
  ...
  <div class="jfhead" style="height: 155px">
    ...
    <div class="desc" style="width: 100%;height: 70px;">
      ...
      <p class="num" id="general_balance" style="width: 100%;text-align: center;">0</p>
    </div>
    <div class="hadle" style="width: 100%;text-align: center;margin-top: -11px;height: 50px;padding: 0;">
      ...
      <div class="buts">
        <%--<a class="b1" onclick="joinIntegralRecharge()">充值</a>--%>
        <a onclick="joinIntegralExchange()">兑换</a>
        <a onclick="joinGeneralIntegralWithdraw()" class="b2">提现</a>
      </div>
    </div>
  </div>
  <!-- 积分END -->
  ...
  <div class="pubtabmenu" id="pubtabmenu">
    <div class="wrap">
      <a class="item sel" onclick="listOptionInit(0)" id="xf_item">消费明细</a>
      <a class="item" onclick="listOptionInit(1)" id="cz_item">收入明细</a>
      <a class="item" onclick="listOptionInit(2)" id="tx_item">提现明细</a>
    </div>
  </div>
  <!-- Tab菜单 END -->
  ...
  <div class="condetaile">
    ...
    <ul class="list" id="withdraw_detail_ul">
      <li class="item">
        <div class="left">
          <span class="name">银币兑换</span>
          <span class="time">余额：11100</span>
  ...
  <div class="publicnull" id="publicnull_tip">
    ...
    <p class="text" id="request_tip">您还没有积分消费记录</p>
  </div>
