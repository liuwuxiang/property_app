    ...
    <form>
      ...
      <div class="fgroup">
        <label class="fitem full">
          <input class="fselect" type="text" placeholder="请选择您要缴费的地区" value="昆明市电信宽带费" id="selectBank">
        </label>
      </div>
      
      <label class="biginput">
        <p class="name">宽带号码</p>
        <input type="text" class="btext" name="" placeholder="请填写您的宽带号码">
      </label>

      <div class="fhandle">
        <a href="/property_system/wx/v1.0.0/joinBroadbandPaymentPay" class="fsubmit">提交申请</a>
      </div>
    </form>
  </div>
