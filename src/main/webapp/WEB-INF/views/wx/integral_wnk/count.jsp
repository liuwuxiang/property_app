...
<div class="header mui-col-sm-12 mui-col-xs-12">
    ...
    <div class="tool-bar mui-col-sm-12 mui-col-xs-12">
        <a href="${ctx}/wx/v1.0.0/joinWnkIntegralIndex?business_id=${business_id}" class="mui-btn">
            <span class="mui-icon mui-icon mui-icon-bars" style="color: #fc9153;"></span>
            积分商城
        </a>
        <a href="${ctx}/wx/v1.0.0/joinMyIntegralOrderByWnk?business_id=${business_id}" class="mui-btn">
            <span class="mui-icon mui-icon mui-icon-bars" style="color: #fc9153;"></span>
            我的订单
        </a>
    </div>
...
<script src="${ctx}/js/wx/integral_wnk/count.js"></script>
