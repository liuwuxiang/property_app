...
<head>
    ...
    <script src="/property_system/js/wnk_business/set_commodity.js"></script>
...
<body class="bgw" onload="initData(${commodity_id})">
...
<div class="head">
    ...
    <a onclick="setCommodity()" class="submit">保存</a>
</div>
<div class="h88"></div>
<ul class="commodity_information_ul">
    ...
    <li>
        ...
        <a class="line_commodity_state" id="line_commodity_state">()</a>
        <div class="mui-switch mui-active is_line_switch mui_switch_line" id="commodity_state_switch">
            <div class="mui-switch-handle"></div>
        </div>
    </li>
    <li>
        <a class="value_name_tip commodity_line_tag">允许万能卡消费</a>
        <a class="line_commodity_state" id="is_make_wnk">()</a>
        <div class="mui-switch mui-active is_line_switch mui_switch_wnk" id="is_make_wnk_switch">
            <div class="mui-switch-handle"></div>
        </div>
    </li>
    <li>
