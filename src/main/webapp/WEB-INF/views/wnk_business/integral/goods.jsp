...
<head>
    ...
    <%--页面专属CSS--%>
    <link rel="stylesheet" type="text/css" href="${ctx}/css/wnk_business/integral/type.css">
...
<div id="isYes">
    <div class="weui-cells__title">已启用的商品</div>
    <div class="memmenu" style="margin-top: 0px;border-width: 1px;" id="yes">
        <%--<a href="${ctx}/wnk_business/joinIntegralGoodsEdit?goods_id=1" class="item member">商品名称1</a>--%>
        <%--<a href="${ctx}/wnk_business/joinIntegralGoodsEdit?goods_id=2" class="item member">商品名称2</a>--%>
        <%--<a href="${ctx}/wnk_business/joinIntegralGoodsEdit?goods_id=3" class="item member">商品名称3</a>--%>
    </div>
    <div class="weui-cells__title">已禁用的商品</div>
    <div class="memmenu" style="margin-top: 0px;border-width: 1px;" id="no">
        <%--<a href="${ctx}/wnk_business/joinIntegralGoodsEdit?goods_id=4" class="item member">商品名称4</a>--%>
        <%--<a href="${ctx}/wnk_business/joinIntegralGoodsEdit?goods_id=5" class="item member">商品名称5</a>--%>
        <%--<a href="${ctx}/wnk_business/joinIntegralGoodsEdit?goods_id=6" class="item member">商品名称6</a>--%>
    </div>
</div>


<div class="memmenu" style="margin-top: 0px;border-width: 1px;">
    <a href="${ctx}/wnk_business/joinIntegralGoodsEdit" class="weui-btn weui-btn_primary ">新增商品</a>
</div>
...
<script src="${ctx}/js/wnk_business/integral/goods.js"           ></script>
<script>
    $(function() {
