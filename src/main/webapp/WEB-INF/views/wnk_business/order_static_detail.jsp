...
<head>
    ...
    <script src="/property_system/js/wnk_business/order_static_detail.js"></script>
    <script src="/property_system/js/wnk_business/general_lib.js"></script>
    <script src="/property_system/js/wx/hui.js"></script>
    <link href="/property_system/css/wx/hui.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="http://res.wx.qq.com/open/js/jweixin-1.1.0.js"></script>
</head>
<body class="bgw" onload="initData('${year_month}',${state},${make_type})">
<!-- 头部STR -->
<div class="head">
    <h1 id="title_tag">统计详情</h1>
    <a onclick="back()" class="back"></a>
    <%--<a onclick="scanQrCode()" class="scan"></a> --%>
</div>
<div class="h88"></div>
