...
<head>
    ...
    <script src="${ctx}/js/admin/integralType.js"></script>
</head>
<body onload="initTableAndData()">

<div class="member_level_manager_top_div">
    <button class="layui-btn layui-btn-sm" onclick="addIntegralTypeEdit()">
        <i class="layui-icon">&#xe654;</i> 新增
    </button>

    <button class="layui-btn layui-btn-sm" onclick="setIntegralTypeEdit()">
