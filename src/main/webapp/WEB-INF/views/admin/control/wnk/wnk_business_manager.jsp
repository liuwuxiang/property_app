...
<head>
    ...
    <script src="${ctx}/js/admin/wnk_business_manager.js"></script>
</head>
...
<div class="members_manager_top_div">
    ...
    <button class="layui-btn layui-btn-sm" onclick="joinEspciallyRecommend()">
        <i class="layui-icon">&#xe61f;</i> 加入特别推荐
    </button>
