...
<head>
    ...
    <script src="/property_system/js/admin/wnk_business_type/set_wnk_business_type.js"></script>
</head>
<body onload="getTypeDetail()">
...
<ul class="set_member_level_ul">
    ...
    <li id="member_price_li" style="display: none;">
    ...
    <li id="zhekou_li" style="display: none;">
        <a>折扣比例(%)</a>
