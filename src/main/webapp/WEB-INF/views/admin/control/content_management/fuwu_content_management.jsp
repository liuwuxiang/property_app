...
<head>
    ...
    <script src="${ctx}/js/admin/content_management/fuwu_content_management.js"></script>
...
<div class="member_level_manager_top_div">
    <button class="layui-btn layui-btn-sm" onclick="addFuwuContent()">
        <i class="layui-icon">&#xe654;</i> 新增
    </button>

    <button class="layui-btn layui-btn-sm" onclick="updateFuwuContent()" >
...
<div class="member_level_manager_top_div">
    ...
    <form class="layui-form" action="" onsubmit="return false;" style="margin-top: 10px">
        <div class="layui-inline">
            <input class="layui-input" placeholder="服务内容名称" id="name" autocomplete="off">
        </div>
