...
<head>
    ...
    <script src="${ctx}/js/admin/legalize/audited_legalize.js"></script>
...
<div class="members_manager_top_div">
    <form class="layui-form" action="" onsubmit="return false;" style="margin-top: 10px">
        ...
        <div class="layui-inline">
            <input type="text" class="layui-input" id="stop_time" placeholder="请选择审核时间">
        </div>
        <button class="layui-btn" data-type="reload" onclick="SearchBusinessAuditedLegalize()">
