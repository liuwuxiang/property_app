...
function initTableAndData() {
    layui.use(['table', 'laydate'], function () {
        ...
        table.render({
            ...
            , page: true
            , url: '/property_system/admin/getAllUserWithdrawOrders'
...
function lookWithdrawOrderDetail() {
    ...
    if (length == 0) {
        ...
        var index = layer.open({
            type: 2,
            title: '提现订单详情',
            content: '/property_system/admin/withdrawOrderDetail?record_id=' + model.id,
            area: ['100%', '100%'],
            maxmin: true
        });
    }
...
function alreadyPresentedAction(record_id) {
    ...
    $.ajax({
        url: "/property_system/admin/alreadyPresentedAction",
        type: "POST",
        dataType: 'json',
...
function noPasswithdrawAction(record_id) {
    var loading_index = layer.load(1);
    $.ajax({
        url: "/property_system/admin/refusingPresentAction",
        type: "POST",
        dataType: 'json',
        data: {"record_id": record_id},
        success: function (data) {
...
function passwithdrawAction(record_id) {
    var loading_index = layer.load(1);
    $.ajax({
        url: "/property_system/admin/withdrawPassFK",
        type: "POST",
        dataType: 'json',
        data: {"record_id": record_id},
        success: function (data) {
...
function Search() {
    ...
    table.render({
        ...
        , page: true
        , url: '/property_system/admin/adminSearchUserWithdrawOrdersInfoByConditions'
        ,where: {
