    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'name',    title: '服务内容名称',sort:true },
...
function Search() {
    ...
    table.render({
        elem: '#members_manager_table'
        ,url: '/property_system/admin/adminSearchFContentInfoByConditions'
        ,cols: [[
            {type:'checkbox'},
            {field:'id',      title: 'id',sort:true         },
            {field:'name',    title: '服务内容名称',sort:true},
...
function updateFuwuContent(){
    ...
    if (length == 0){
        ...
        layer.open({
            type: 2,
            title: '编辑服务内容',
            content: '/property_system/admin/joinInsertOrUpdateContentInfo?content_id='+model.id+'&type=0',
            area: ['100%', '100%'],
            maxmin: true
        });
    }
