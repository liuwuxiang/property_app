    ...
    layui.use(['table', 'laydate'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'stop_time', title: '审核时间', sort: true}
            ]]
            , page: true
            , url: '/property_system/admin/getWnkBusinessAuditedLegalizeAll'
...
// 根据条件模糊查询
function SearchBusinessAuditedLegalize() {
    ...
    table.render({
        elem: '#members_manager_table'
        , url: '/property_system/admin/adminSearchWnkBusinessAuditedLegalizeInfoByConditions'
        , cols: [[
            {type: 'checkbox'}
            , {field: 'id', title: 'ID',sort:true}
            , {field: 'business_id', title: '商家ID',sort:true}
