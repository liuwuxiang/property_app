...
function initTableAndData(){
    layui.use(['table', 'laydate'], function(){
        ...
        table.render({
            ...
            ,page: true
            ,url:'/property_system/admin/getAllWnkBusiness'
...
function addBusiness(){
    ...
    var index = layer.open({
        type: 2,
        title: '添加商户',
        content: '/property_system/admin/joinAddWnkBusinessManager',
        area: ['100%', '100%'],
        maxmin: true
    });
}
...
//加入特别推荐
function joinEspciallyRecommend(){
    var table = layui.table;
    var checkStatus = table.checkStatus('members_manager_table')
        ,data = checkStatus.data;
    var length = data.length;
