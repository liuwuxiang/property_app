...
function submitAuthentication() {
    ...
    if (real_name == undefined || real_name == ""){
        ...
        $.ajax({
            ...
            type:"POST",
            dataType : 'json',
            data:{"user_id":storage["user_id"],"type":1,"real_name":real_name,"id_card_number":id_card_number,"school":"","mobile":mobile,"code":code},
            success:function(data){
                toast(1,data.msg);
                if (data.status == 0){
                    self.window.location.href = "/property_system/wx/v1.0.0/joinUpgradeMyMemberCard?open_card_type=2";
                }
            },
        });
    }
